...
export class WorldItem {
    ...
    firstSeenLabel = null;
    outlineGlow;
    constructor(scene, x, y, data, depthBand, showFirstSeenTip = false) {
        this.scene = scene;
        this.data = data;
    ...
    update(deltaSeconds, worldSpeed) {
        if (this.isLatched || this.isDelivered || this.isDestroyed)
            return;
